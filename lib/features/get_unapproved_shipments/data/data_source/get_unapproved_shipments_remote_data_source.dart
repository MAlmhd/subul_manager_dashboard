...
class GetUnapprovedShipmentsRemoteDataSourceImpl
  ...
  @override
  Future<List<UnApprovedShipmentsEntity>> getUnapprovedShipments() async{
     final token = await sl.get<AuthLocalDataSource>().getToken();
   var data = await _apiService.get(endPoint: 'get/unapproved/shipments',headers: {'Authorization': 'Bearer $token'});
