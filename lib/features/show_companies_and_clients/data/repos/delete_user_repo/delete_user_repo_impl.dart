...
import 'package:subul_manager_dashboard/features/show_companies_and_clients/data/data_source/delete_user_data_source/delete_user_local_data_source.dart';
...
class DeleteUserRepoImpl implements DeleteUserRepo {
 ...
 // final DeleteUserLocalDataSource deleteUserLocalDataSource;
  ...
  Future<Either<Failure, DeleteUserEntity>> delete({required int id}) async {
    try {
      // حذف من API
      DeleteUserEntity deleteUserEntity = await deleteUserRemoteDataSource.deleteUser(id: id);

      // // ✅ حذف من التخزين المحلي
      // await deleteUserLocalDataSource.deleteCompany(id);
