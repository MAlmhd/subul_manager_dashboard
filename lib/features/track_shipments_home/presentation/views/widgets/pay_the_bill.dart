...
class _PayTheBillState extends State<PayTheBill> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      showSnackBar(context, "تم إنشاء الفاتورة بنجاح", Colors.green);
    }
                  },
                     ...
                     return CustomProgressIndicator();
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          if (taxPercentageController.text.trim().isEmpty) {
                            showSnackBar(
                              context,
                              "أدخل نسبة الضريبة",
                              Colors.red,
                          ...
                          double priceDecimal = double.parse(
                          ...
                          context.read<CreateInvoiceCubit>().createInvoice(customerId: widget.approvedShipmentEntity.idOfCustomer, shipmentId: widget.approvedShipmentEntity.idOfShipment, amount: priceDecimal, includesTax: isTaxIncluded, taxAmount: taxDecimal / 100, payableAt: formattedDate);
                        },
                        child: Container(
                          width: 60.w,
                          height: 40.h,
